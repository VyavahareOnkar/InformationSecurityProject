...
os.chdir("C:/xampp/htdocs/FindOurs-main/fingerprint_recognition/fingerprint-recognition/")
...
img2 = cv2.imread("C:/xampp/htdocs/FindOurs-main/fingerprint_recognition/fingerprint-recognition/db2/" + image_name, cv2.IMREAD_GRAYSCALE)
kp2, des2 = get_descriptors(img2)


# Load image data from json
with open("C:/xampp/htdocs/FindOurs-main/fingerprint_recognition/fingerprint-recognition/api/data.json", "r") as file:
	data = json.load(file)
